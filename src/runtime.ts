...
import { VirtualSubaccount, type Seed } from './account.js';
...
export const DEMO_PRINCIPAL_KEY = '0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d' as const; // hardhat/anvil #1 — demo ONLY
...
export function buildRuntime(opts: { seed?: Seed } = {}): Runtime {
  ...
  const broker = new Broker(subaccount, { workerId: 'broker-1', market, feeUsdc: process.env.DEALFLOW_FEE_USDC ?? '12.50' });
